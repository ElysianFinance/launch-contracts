...
const { ensureOnlyExpectedMutativeFunctions, toUnit, toBN} = require('../src/utils');
...
contract('TokenState', accounts => {
    ...
    it('when invoked, it sets the correct allowance', async () => {
        ...
        await instance.setAllowance(account_owner, account_user1, toUnit('100'), { from: account_owner });
    ...
    it('setBalance should fail from user account', async () => {
        ...
        await truffleAssert.reverts(
			instance.setBalanceOf(account_user2, toUnit('25'), { from: account_user1 }),
    ...
    it('when invoked, it sets the correct balance', async () => {
        ...
        await instance.setBalanceOf(account_user2, toUnit('25'), { from: account_owner });
